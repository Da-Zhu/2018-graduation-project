...
class FaceRec(QWidget):
    ...
    def setupUi(self, FaceRec):
        ...
        '''
        self.pushButton_back = QtGui.QPushButton(FaceRec)
        self.pushButton_back.setGeometry(QtCore.QRect(300, 600, 80, 50))
        self.pushButton_back.setFont(font)
        self.pushButton_back.clicked.connect(self.pushButton_send_clicked)
        '''
    ...
    def retranslateUi(self, FaceRec):
       ...
       #self.pushButton_back.setText(_translate("FaceRec", u"串口发送", None))
